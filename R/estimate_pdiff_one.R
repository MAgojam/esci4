...
estimate_pdiff_one <- function(
  ...
  if (!is.null(estimate)) {
    ...
    estimate$es_proportion_difference[2, c("effect_size", "LL", "UL", "SE")] <-
      c(reference_p, NA, NA, NA)
    estimate$es_proportion_difference[3, c("effect_size", "LL", "UL")] <-
      estimate$es_proportion_difference[3, c("effect_size", "LL", "UL")] - reference_p
