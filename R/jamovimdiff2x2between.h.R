...
jamovimdiff2x2betweenOptions <- if (requireNamespace("jmvcore", quietly=TRUE)) R6::R6Class(
    "jamovimdiff2x2betweenOptions",
...
jamovimdiff2x2betweenResults <- if (requireNamespace("jmvcore", quietly=TRUE)) R6::R6Class(
    "jamovimdiff2x2betweenResults",
    ...
    public = list(
        initialize = function(options, data=NULL, datasetId="", analysisId="", revision=0) {
            super$initialize(
                ...
                version = c(1,0,0),
                options = options,
                results = jamovimdiff2x2betweenResults$new(options=options),
                data = data,
                datasetId = datasetId,
...
jamovimdiff2x2between <- function(
    ...
    if ( ! requireNamespace("jmvcore", quietly=TRUE))
        stop("jamovimdiff2x2between requires jmvcore to be installed (restart may be required)")
    ...
    analysis <- jamovimdiff2x2betweenClass$new(
        options = options,
        data = data)
